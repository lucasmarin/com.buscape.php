...
require_once 'src/api/buscape/BuscapeFindCategoryListOperation.php';
require_once 'src/api/buscape/BuscapeFindOfferListOperation.php';
require_once 'src/api/buscape/BuscapeFindProductListOperation.php';
require_once 'src/api/buscape/BuscapeTopProductsOperation.php';
require_once 'src/api/buscape/BuscapeViewProductDetailsOperation.php';
require_once 'src/api/buscape/BuscapeViewSellerDetailsOperation.php';
require_once 'src/api/buscape/BuscapeViewUserRatingsOperation.php';
